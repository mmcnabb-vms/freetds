...
static size_t
tds_strftime_tm(char *buf, size_t maxsize, const char *format, const struct tm *ptm, TDS_INT decimicrosecond, int prec)
{
	struct tm tm;
...
size_t
tds_strftime_maxsize(const char *format, int prec)
{
	char buf[1000];
	struct tm tm = { 0 };
